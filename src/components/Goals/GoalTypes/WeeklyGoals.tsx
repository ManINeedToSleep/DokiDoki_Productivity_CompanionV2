...
export default function WeeklyGoals({ goals, isOpen, onToggle, onDelete, allowEditing = false }: WeeklyGoalsProps) {
  return (
    <div>
      <div 
        onClick={onToggle}
      ...
      >
        <h3 className="font-[Halogen] text-pink-600 mb-2">Weekly Goals</h3>
