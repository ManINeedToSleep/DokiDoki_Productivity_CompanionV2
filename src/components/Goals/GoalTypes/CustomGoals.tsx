...
export default function CustomGoals({ goals, isOpen, onToggle, onDelete, allowEditing = false }: CustomGoalsProps) {
  return (
    <div>
      <div 
        onClick={onToggle}
      ...
      >
        <h3 className="font-[Halogen] text-pink-600 mb-2">Custom Goals</h3>
